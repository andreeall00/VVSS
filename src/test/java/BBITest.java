...
public class BBITest {
    ...
    @Test()
    public void t1_addTema() throws Exception {
    ...
    @Test
    public void t2_addStudent() throws Exception {
    ...
    @Test
    public void t3_addNota() throws Exception {
        Nota nota = new Nota("185", "2778", "27", 10, LocalDate.now());
        Exception thrown = assertThrows(
                Exception.class,
                () -> service.addNota(nota, "feedback")
        );
        assertTrue(thrown.getMessage().contains("Studentul nu exista!"));
    }

    @Test
    public void t4_all() throws Exception {
        Tema tema = new Tema("27", "Ana Pop", 3, 1);
